...
chosen_symbol_df, compare_symbol_df = bf.get_golden_data(chosen_symbol, compare_symbol, timeframe)

pair_df = bf.get_pairs(chosen_symbol_df, compare_symbol_df)
used_data_df = pair_df
...
fig.savefig('backtest_{}{}_{}_{}_{}_{}.png'.format(figures_path, chosen_symbol, compare_symbol, timeframe,
                                          threshold, period))
...
plt.savefig('PnL_{}{}_{}_{}_{}_{}.png'.format(PnL_path, chosen_symbol, compare_symbol, timeframe,
                                     threshold, period))

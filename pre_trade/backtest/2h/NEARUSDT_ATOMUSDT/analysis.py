...
#print(test_results_threshold_2_df)
...
plt.plot(test_results_threshold_2_df['period'].tolist(),test_results_threshold_2_df['Sharpe ratio'].tolist(),label='test',color='Red')
plt.xlabel('Period')

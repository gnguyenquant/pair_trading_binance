...
test_path = backtest_path+'test/'
test_results_path = test_path+'results/'
test_figures_path = test_path+'figures/'
...
# calculate z-score
test_df = BF.get_zscore(test_df, slope, period)

# backtest
test_df['price_chosen'] = np.exp(test_df['log_price_chosen'])
test_df['price_compare'] = np.exp(test_df['log_price_compare'])
time_series = test_df['Open Time'].tolist()
price_chosen = test_df['price_chosen'].tolist()
price_compare = test_df['price_compare'].tolist()
zscore = test_df['z-score'].tolist()
...
with open('{}{}_{}_{}_{}_{}_{}_{}.txt'.format(test_results_path, chosen_symbol, compare_symbol, timeframe,
...
fig.savefig('{}{}_{}_{}_{}_{}_{}_{}.png'.format(test_figures_path, chosen_symbol, compare_symbol, timeframe,
                                                threshold, takeprofit, stoploss, period))

with open('{}backtest_test_{}.csv'.format(test_path,timeframe), 'a') as f:
